        ...
        <div className="relative mx-auto max-w-7xl px-6 py-28 md:py-40 grid md:grid-cols-12 gap-10">
          <div className="md:col-span-8 animate-fade-up">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link to="/contato" className="inline-flex items-center gap-2 rounded-full bg-gradient-gold px-7 py-3.5 text-sm font-medium text-gray-100 shadow-gold transition-smooth hover:-translate-y-0.5">
